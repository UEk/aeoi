...
import { Trash2, Palette, Moon, Sun, Waves, Trees, Sunset as SunsetIcon, Snowflake, Coffee, Zap, Radio, Flower2, Square, Sparkles, Crown, CoffeeIcon } from 'lucide-react';
...
const themes: ThemeOption[] = [
  ...
  },
  {
    ...
    icon: Crown,
    preview: 'from-yellow-400 via-black to-red-600',
    colors: { bg: 'bg-gray-900', accent: 'bg-yellow-400', text: 'text-white' }
  },
  {
    id: 'fika',
    name: 'Swedish Fika',
    description: 'Mysig & cozy',
    icon: CoffeeIcon,
    preview: 'from-amber-200 via-blue-400 to-yellow-300',
    colors: { bg: 'bg-blue-50', accent: 'bg-blue-500', text: 'text-gray-900' }
  }
];
